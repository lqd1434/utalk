  ...
  Widget build(BuildContext context) {
   return GridView(
       ...
       children:const <Widget>[
          Icon(Icons.ac_unit,size: 35,color: Colors.lightBlueAccent,),
          Icon(Icons.airport_shuttle,size: 35,color: Color.fromRGBO(223, 116, 114, 1),),
          ...
          Icon(Icons.keyboard_arrow_down,size: 35,color: Colors.lightGreen,),
       ]
   );
  }
}
